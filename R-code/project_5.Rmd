...
plot <- ggplot() +
        ...
        labs(x = '', y = '% of times entering in the top 10', title = 'Concistency of the top biathletes - Men')+
...
plot <- ggplot() +theme_bw()+
        geom_histogram(aes(efficiency_list[['Fourcade Martin ']], y=..density.., 
                       fill='Fourcade Martin '), alpha=0.9, color='white', 
        ...
        geom_histogram(aes(efficiency_list[['Windisch Dominik ']], y=..density.., 
             ...
             labs(fill = 'Athlete', x='Efficiency', y='PDF', 
                title='Efficiency of the best and worst shooters - Men') +
                   theme(plot.title = element_text(size=15),
                         legend.text = element_text(size=10),
                          legend.title = element_text(size=12),
                          axis.text.x = element_text(size=10),
                          ...
                          axis.title.x = element_text(size=12),
                          axis.title.y = element_text(size=12)) +
        scale_fill_manual(values= c('Fourcade Martin ' = 'firebrick', 
...
plot <- ggplot() + theme_bw()+
        geom_histogram(aes(efficiency_list_w[['Dahlmeier Laura ']], y=..density.., 
                       fill='Dahlmeier Laura '), alpha=0.9, color='white', 
                       bins = bins_fd(efficiency_list_w[['Domracheva Darya ']])) +
        geom_histogram(aes(efficiency_list_w[['Hojnisz-Starega Monika ']], y=..density.., fill='Hojnisz-Starega Monika '), alpha=0.9, color='white', 
                       bins=bins_fd(efficiency_list_w[['Hojnisz-Starega Monika ']]))+ 
  
         labs(fill = 'Athlete', x='Efficiency', y='PDF', 
                title='Efficiency of the best and worst shooters - Women') +
                   theme(plot.title = element_text(size=15),
                         legend.text = element_text(size=10),
                          legend.title = element_text(size=12),
                          axis.text.x = element_text(size=10),
                          ...
                          axis.title.x = element_text(size=12),
                          axis.title.y = element_text(size=12)) +
        scale_fill_manual(values= c('Dahlmeier Laura ' = 'firebrick', 
                                    'Hojnisz-Starega Monika ' = 'navy')) +
...
plot <- ggplot() +theme_bw()+
        geom_histogram(aes(efficiency_list[[min_eff$`Full Names`]], y=..density.., 
                       fill='Schempp Simon '), alpha=0.9, color='white', 
                ...
                title='Athletes with the best and worst efficiency - Men') +
                   theme(plot.title = element_text(size=15),
                         legend.text = element_text(size=10),
                          ...
                          axis.title.x = element_text(size=12),
                          axis.title.y = element_text(size=12)) +
        scale_fill_manual(values= c('Schempp Simon ' = 'firebrick', 
                                    'Windisch Dominik ' = 'navy')) +
                ...
                title='Athletes with the best and worst efficiency - Women') +
                   theme(plot.title = element_text(size=15),
                         legend.text = element_text(size=10),
                          ...
                          axis.title.x = element_text(size=12),
                          axis.title.y = element_text(size=12)) +
        scale_fill_manual(values= c('Bescond Anais ' = 'firebrick', 
                                    'Hinz Vanessa ' = 'navy')) +
...
plot <- ggplot() +   theme_bw() +
        geom_density(aes(efficiency_list[[names_ordered[10]]], y=..density..,
                           color=names_ordered[10]) 
                       , alpha=0.5, lwd=1) +
        g
...
plot <- ggplot() +  theme_bw() +
        geom_density(aes(efficiency_list_w[[names_ordered_w[21]]], y=..density..,
                           color=names_ordered_w[21]) 
                       , alpha=0.5, lwd=1) +
        geom_density(aes(efficiency_list_w[[names_ordered_w[18]]], y=..density..,
                          color= names_ordered_w[18]), 
                        alpha=0.5, lwd=1) +

        geom_density(aes(efficiency_list_w[[names_ordered_w[7]]], y=..density..,
                           color= names_ordered_w[7]), 
                        alpha=0.5, lwd=1) 
           labs(color ='Athlete',  x='Effciency', y='PDF',
...
```{r}
named_percentages_w[order_perc_w]
```
...
plot <- plot + geom_vline(aes(xintercept=mean_max),  linetype='dashed')+
              annotate('text', x= mean_max + 0.035, y=14.7, label=sprintf('Max_Mean = %s',round(mean_max,3)), size=2.5)
...
plot <- plot + geom_vline(aes(xintercept=precision_max), linetype='dashed')+
         annotate('text', x=precision_max + 0.035, y=18.8, label=sprintf('Max_Precision = %s',round(precision_max,3)), size=2.5)
plot
```
...
plot <- ggplot() +theme_bw()+
  ...
  annotate('text', x=mean_max + 2.35, y=0.27, label=sprintf('Max_Mean = %s',round(mean_max,3)), size=2.5)+
